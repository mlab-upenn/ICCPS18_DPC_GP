...
for ids = 1:numel(sim_samples)
    ...
    % RANDOM
    datafnamet = 'random_LargeHotel_uniform_2ramped_3input_30day_20171004_2030.mat';
%     datafnamet = 'random_LargeHotel_prbs_2ramped_3input_30day_20171004_2025.mat';
    
    % OED
%     datafnamet = 'doe_LargeHotel_IG_2ramped_3input_14day_20171003_2220.mat';
%     datafnamet = 'doe_LargeHotel_MV_2ramped_3input_14day_20171004_0313.mat';
...
saveStr = datafnamet;
save(fullfile('results_sqexp', saveStr), 'results');
