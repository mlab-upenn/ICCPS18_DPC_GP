...
Batt_params = struct('power_max', 50000, ...% Battery max charge/discharge power [W]
    ...
    'power_weight', 0.75, ...   % probability of satisfying the power constraint
    'soc_weight', 0.75, ...     % probability of satisfying the SoC constraint
...
control_gp_model_file = 'random_21init_30shift_21update_16day';
%control_gp_model_file = 'evolving_21init_30shift_21update_16day';
