# -*- coding: utf-8 -*-
"""
Created on Thu Apr 27 20:40:38 2017
...
XdTrain, XcTrain, yTrain = load_data('unconstrained', buildingType, features_d, features_c, output)
...
if save_results:
    ...
    filename = ('../models/gp-unconstrained-%s-numsamples-%s.pickle' %(buildingType, n_samples))
