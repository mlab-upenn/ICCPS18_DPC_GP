...
XdTrain, XcTrain, yTrain = load_data('constrained', buildingType, features_d, features_c, output)
...
if save_results:
    ...
    filename = ('../models/gp-constrained-%s-numsamples-%s.pickle' %(buildingType, n_samples))
