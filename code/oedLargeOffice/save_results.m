...
for idsim = 1:numel(sim_samples)
    ...
    n_samples = sim_samples(idsim);
    results(idsim).n_samples = n_samples;
    
    % training data
%     datafnamet = 'random_LargeOffice_uniform_2ramped_3input_28day_20171003_1922.mat';
%     datafnamet = 'random_LargeOffice_uniform_3input_28day_20171003_1924.mat';
    datafnamet = 'random_LargeOffice_prbs_2ramped_3input_28day_20171003_1922.mat';
%     datafnamet = 'random_LargeOffice_prbs_3input_28day_20171003_1923.mat';
%     datafnamet = 'doe_LargeOffice_IG_2ramped_3input_21day_20171003_1804.mat';
    ...
    results(idsim).data = data;
    
    % GP training
    model = train_gp(X_train_norm, y_train_norm);
    results(idsim).model = model;
    ...
    results(idsim).train_results = train_results;
    ...
    results(idsim).test_results = test_results;
    
end

saveStr = datafnamet;
save(fullfile('results', saveStr), 'results');
