...
They are permitted only in a small window or during non-business hours. 
Even a few hours of periodic OED can provide far better models due to its ability to capture more information in the same amount of time.
...
For the office building, our results show that the updated GP model is better in all the cases with lower RMSE.
 ...
 \begin{table}[htbp]
	...
	\scalebox{0.9}{
		\begin{tabular}{c|cc|cc|cc}
			...
			\midrule
			Updated GP    & 58.9 & 59.4  & 86.4  &85.7  & 99.7 & 94.9  \\
