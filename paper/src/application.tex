...
%	\setlength\fwidth{0.44\textwidth}
%	\setlength\hwidth{0.1\textwidth}	
%	\input{figures/control-cooling.tex}	
%	\caption{Optimal cooling setpoint}
%	\label{F:control:cooling}
%\end{subfigure}
%\begin{subfigure}
%	\centering
%	\setlength\fwidth{0.44\textwidth}
%	\setlength\hwidth{0.1\textwidth}	
%	\input{figures/control-supplyair.tex}	
%	\caption{Optimal supply air temperature.}
%	\label{F:control:supplyair}
%\end{subfigure}
%\begin{subfigure}
%	\centering
%	\setlength\fwidth{0.44\textwidth}
%	\setlength\hwidth{0.1\textwidth}	
%	\input{figures/control-chilled.tex}	
%	\caption{Optimal chilled water temperature.}
%	\label{F:control:chilled}
%\end{subfigure}
\begin{subfigure}
	\centering
	\setlength\fwidth{0.44\textwidth}
...
The GP model used in Sec.~\ref{SS:power_tracking} uses data \(\D\) generated from the OED procedure in Sec.~\ref{SS:casestudy:oed}.
We run the same controller in a closed loop with the building for two weeks and collect the data \(\D'\) generated in the process.
Since \(\D'\) does not contain a wide range of input excitation, but it contains useful information, for example about the recent periodic trends, that is beneficial in updating the GP model.
...
Therefore, we select the most informative subset of data \(\mathcal{S} \subset \{\D \cup \D' \} \).
 ...
 \begin{table}[t]
	...
	\scalebox{0.9}{
		\begin{tabular}{c|cc|cc|cc}
			...
			\% decrease   & 9.6 \(\% \downarrow\)  & 6.9 \(\%\downarrow\) & 5.9 \(\%\downarrow\)  & 7.9 \(\%\downarrow\) &  5.3 \(\%\downarrow\)  & 6.4 \(\%\downarrow\) \\
			\bottomrule
		\end{tabular}
	}
