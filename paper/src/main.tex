...
\author{\IEEEauthorblockN{Achin Jain\thanks{$^{\star}$These authors contributed equally to this work.}$^{\star,\S}$, Truong X. Nghiem$^{\star,\S,\ddag}$, Manfred Morari$^{\S}$, Rahul Mangharam$^{\S}$}
