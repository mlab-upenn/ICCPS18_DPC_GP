...
\author{\IEEEauthorblockN{Achin Jain\thanks{$^{\star}$These authors contributed equally to this work.}$^{\star,\S}$, Truong X. Nghiem$^{\star,\ddag}$, Manfred Morari$^{\S}$, Rahul Mangharam$^{\S}$}
